...
<img
    ...
    src={"/images/optimizing/benny.png"}
/>
...
<img
    ...
    src={"/images/optimizing/june.webp"}
/>

![](/images/optimizing/p2.png)
...
<TwoColumnEquations>
    <Math>{(s=>s.raw)`\[\sum_{m \in \mathcal{M}} \sum_{b \in \mathcal{B}} (r_b) X_{mb}\]`[0]}</Math>
